...
void sheet_refresh(struct SHTCTL *ctl, struct SHEET *sht, int bx0, int bx1, int by0, int by1);
void sheet_refreshsub(struct SHTCTL *ctl, int bx0, int bx1, int by0, int by1);
